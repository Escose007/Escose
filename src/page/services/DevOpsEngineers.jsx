      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Service",
            "name": "DevOps Engineer Hiring Service",
            "description": "Hire expert DevOps engineers in 2 weeks. AWS, Azure, Kubernetes specialists. Pre-vetted engineers with CI/CD, Docker, Terraform expertise. Staff augmentation and dedicated teams available.",
            "provider": {
              "@type": "Organization",
          ...
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://escose.com/services/devops-engineers"
              }
            ]
          })}
        </script>
