...
export const technologies = [
  {
    ...
    tech: [
      ...
      { title: 'Next.js', img: 'https://cdn.simpleicons.org/nextdotjs/000000' },
      { title: 'TypeScript', img: 'https://cdn.simpleicons.org/typescript/3178C6' },
      { title: 'Svelte', img: 'https://cdn.simpleicons.org/svelte/FF3E00' },
      { title: 'Tailwind CSS', img: 'https://cdn.simpleicons.org/tailwindcss/06B6D4' },
  ...
  },
  {
    ...
    tech: [
      ...
      { title: 'Node', img: node },
      { title: 'Go', img: go },
      { title: 'Rust', img: 'https://cdn.simpleicons.org/rust/000000' },
      { title: 'FastAPI', img: 'https://cdn.simpleicons.org/fastapi/009688' },
      { title: 'GraphQL', img: 'https://cdn.simpleicons.org/graphql/E10098' },
    ],
  },
  {
    title: 'mobile',
    tech: [
      ...
      { title: 'Swift', img: 'https://cdn.simpleicons.org/swift/FA7343' },
      { title: 'Kotlin', img: 'https://cdn.simpleicons.org/kotlin/7F52FF' },
    ],
  },
  {
    title: 'cloud',
    tech: [
      ...
      { title: 'Kubernetes', img: 'https://cdn.simpleicons.org/kubernetes/326CE5' },
      { title: 'Docker', img: 'https://cdn.simpleicons.org/docker/2496ED' },
      { title: 'Terraform', img: 'https://cdn.simpleicons.org/terraform/7B42BC' },
    ],
  },
  {
    title: 'Database',
    tech: [
      ...
      { title: 'Redis', img: 'https://cdn.simpleicons.org/redis/DC382D' },
      { title: 'Cassandra', img: 'https://cdn.simpleicons.org/apachecassandra/1287B1' },
      { title: 'Elasticsearch', img: 'https://cdn.simpleicons.org/elasticsearch/005571' },
    ],
  },
  {
    title: 'AI/ML',
    tech: [
      { title: 'TensorFlow', img: 'https://cdn.simpleicons.org/tensorflow/FF6F00' },
      { title: 'PyTorch', img: 'https://cdn.simpleicons.org/pytorch/EE4C2C' },
      { title: 'OpenAI', img: 'https://cdn.simpleicons.org/openai/412991' },
      { title: 'LangChain', img: 'https://cdn.simpleicons.org/langchain/1C3C3C' },
      { title: 'Hugging Face', img: 'https://cdn.simpleicons.org/huggingface/FFD21E' },
    ],
  },
  {
    title: 'DevOps',
    tech: [
      ...
      { title: 'Kubernetes', img: 'https://cdn.simpleicons.org/kubernetes/326CE5' },
      { title: 'Terraform', img: 'https://cdn.simpleicons.org/terraform/7B42BC' },
      { title: 'Jenkins', img: 'https://cdn.simpleicons.org/jenkins/D24939' },
      { title: 'GitHub Actions', img: 'https://cdn.simpleicons.org/githubactions/2088FF' },
      { title: 'Ansible', img: 'https://cdn.simpleicons.org/ansible/EE0000' },
      { title: 'Prometheus', img: 'https://cdn.simpleicons.org/prometheus/E6522C' },
    ],
  },
];
...
export const openPositions = [
  ...
  },
  {
    ...
    openings: 5,
    postedDate: '20 Dec 2025',
    skills: ['Python', 'FastAPI', 'React.js', 'JavaScript', 'ES6+', 'REST APIs', 'SQL', 'NoSQL', 'Redux', 'Context API', 'HTML', 'CSS'],
    summary: 'We are looking for a skilled Full-Stack Engineer with strong hands-on experience in Python and React to join our growing engineering team. Immediate joiners preferred.',
    applyUrl: 'https://forms.gle/cczcwqa7xpKzLjio9',
    jd: {
      responsibilities: [
        'Develop and maintain scalable full-stack applications using Python (FastAPI) and React.js',
        'Build robust RESTful APIs with proper authentication and data handling',
        'Design and implement responsive, component-based React applications',
        'Optimize application performance for both backend and frontend',
        'Integrate frontend applications with backend APIs',
        'Work with databases (SQL/NoSQL) and handle data integrations',
        'Debug and troubleshoot issues across the full stack',
        'Collaborate with cross-functional teams in a fast-paced environment',
      ],
      requirements: [
        '2–4 years of relevant full-stack development experience (mandatory)',
        'Strong proficiency in Core Python',
        'Hands-on experience with FastAPI',
        'Experience in building RESTful APIs',
        'Working knowledge of authentication, data handling, and performance optimization',
        'Familiarity with databases (SQL/NoSQL) and integrations',
        'Strong experience with React.js',
        'Proficiency in JavaScript (ES6+)',
        'Experience with component-based architecture',
        'Familiarity with state management (Redux / Context API)',
        'Understanding of REST API integration and UI performance optimization',
      ...
      niceToHave: [
        ...
        'Experience with modern build tools and bundlers (Webpack, Vite)',
