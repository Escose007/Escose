...
export const openPositions = [
  {
    jobId: 'ESC2525',
    title: 'Full-Stack Engineer (Python + GenAI + React)',
    ...
    skills: ['Python', 'GenAI', 'LLMs', 'LangChain', 'RAG', 'FastAPI', 'React.js', 'JavaScript', 'REST APIs', 'SQL', 'NoSQL', 'Vector Databases'],
    summary: 'We are hiring a Full-Stack Engineer with strong hands-on experience in Python, Generative AI, and React to build AI-powered products end-to-end. You will work across LLM-backed services, scalable APIs, and modern React frontends.',
    applyUrl: 'https://forms.gle/cczcwqa7xpKzLjio9',
    jd: {
      responsibilities: [
        'Design and build GenAI features using LLMs, prompt engineering, RAG pipelines, and vector databases',
        'Develop and maintain scalable full-stack applications using Python (FastAPI) and React.js',
        'Integrate LLM APIs and AI services into production-grade backend systems',
        ...
        'Optimize application and model-inference performance across backend and frontend',
        'Work with databases (SQL/NoSQL/vector) and handle data integrations',
        'Debug and troubleshoot issues across the full stack',
        'Collaborate with cross-functional teams in a fast-paced environment',
      ],
      requirements: [
        '1–3 years of relevant full-stack development experience (mandatory)',
        'Strong proficiency in Core Python',
        'Hands-on experience building GenAI applications (LLMs, prompt engineering, RAG)',
        'Familiarity with GenAI frameworks/tooling (LangChain, LlamaIndex, or similar)',
        ...
        'Experience with component-based architecture and state management (Redux / Context API)',
        'Familiarity with databases (SQL/NoSQL) and vector databases',
      ...
      niceToHave: [
        ...
        'Knowledge of agentic frameworks (LangGraph, CrewAI)',
  ...
  {
    jobId: 'ESC2521',
    title: 'Lead Linux & Systems Engineer - AI Infrastructure',
    department: 'Engineering',
    location: 'Bangalore',
    type: 'Full-time',
    experience: '6+ years',
    ...
    skills: ['Linux', 'Ubuntu', 'Kernel Engineering', 'PCIe', 'UEFI/BIOS', 'Ansible', 'Python', 'Docker', 'NVIDIA CUDA', 'NCCL', 'RoCEv2', 'InfiniBand', 'eBPF', 'systemd', 'BMC/IPMI', 'Redfish', 'Secure Boot', 'TPM', 'SR-IOV', 'VFIO', 'MPI', 'OpenMPI'],
    summary: 'Design, build, and operate bare-metal AI/HPC GPU clusters. This role suits someone who enjoys getting hands-dirty in firmware, kernel and PCIe, and then scaling that knowledge with Ansible/Python.',
    applyUrl: 'https://forms.gle/cczcwqa7xpKzLjio9',
    jd: {
      responsibilities: [
      ...
      requirements: [
        ...
        '6+ years in Linux systems engineering, including kernel/userspace debugging and performance tuning',
  ...
  {
    jobId: 'ESC2522',
    title: 'Lead AI Runtime Engineer',
    department: 'Engineering',
    location: 'Bangalore',
    type: 'Full-time',
    experience: '5+ years',
    openings: 2,
    postedDate: '25 Dec 2025',
    skills: ['PyTorch', 'TensorFlow', 'JAX', 'Python', 'C++', 'Go', 'Rust', 'Distributed Training', 'Multi-GPU', 'Multi-node', 'Kubernetes', 'Ray', 'TorchElastic', 'LLM Training', 'Checkpointing', 'Performance Optimization', 'Containerization', 'Job Scheduling'],
    summary: 'Architect, build, and optimize the core runtime infrastructure that enables distributed training and deployment of large-scale AI models, including LLMs. Hands-on leadership position for systems-focused software engineers at the intersection of AI workloads, runtime systems, and performance-critical infrastructure. Immediate joiners preferred.',
    applyUrl: 'https://forms.gle/cczcwqa7xpKzLjio9',
    jd: {
      responsibilities: [
        'Own and evolve the core runtime architecture that powers large-scale AI training and inference',
        'Design and implement resilient, elastic runtime capabilities such as dynamic node scaling and automated job recovery within a custom PyTorch-based stack',
        'Strengthen the reliability, orchestration, and fault tolerance of distributed training workloads',
        'Profile, analyze, and optimize low-level system performance across training and inference pipelines',
        'Enhance packaging, deployment, and production integration of customer models',
        'Ensure consistent throughput, latency, and reliability across multi-node, multi-GPU environments',
        'Design and maintain internal libraries and services supporting the full model lifecycle, including training, checkpointing, fault recovery, packaging, and deployment',
        'Implement robust observability, diagnostics, and resilience mechanisms for deep learning workloads',
        'Promote best practices in CI/CD, testing, and software quality across the AI runtime stack',
        'Partner closely with Research, Infrastructure, and Product teams to align runtime capabilities with platform and customer needs',
        'Lead technical discussions, mentor junior engineers, and help scale the AI Runtime team\'s expertise',
      ],
      requirements: [
        '5+ years of experience in systems or software engineering, with strong exposure to AI runtimes, distributed systems, or compiler–runtime interactions',
        'Hands-on experience delivering PaaS services',
        'Proven ability to optimize and scale deep learning runtimes such as PyTorch, TensorFlow, or JAX for large-scale training and/or inference',
        'Strong programming skills in Python and C++; experience with Go or Rust is a plus',
        'Solid understanding of distributed training frameworks, low-level performance tuning, and resource orchestration',
        'Experience working with multi-GPU, multi-node, or cloud-native AI workloads',
        'Practical knowledge of containerised workloads, job scheduling, and failure recovery in production environments',
        'Immediate availability or short notice period (preferred)',
      ],
      niceToHave: [
        'Contributions to PyTorch internals or open-source deep learning infrastructure projects',
        'Familiarity with LLM training pipelines, checkpointing strategies, or elastic training orchestration',
        'Experience with Kubernetes, Ray, TorchElastic, or custom AI job orchestration platforms',
        'Background in systems research, compilers, or runtime architecture for HPC or ML systems',
  ...
  },
  {
    ...
    skills: ['Golang', 'RESTful APIs', 'gRPC', 'PostgreSQL', 'MySQL', 'MongoDB', 'Redis', 'Microservices', 'Docker', 'Kubernetes', 'AWS', 'GCP', 'Azure', 'Kafka', 'RabbitMQ', 'SQS', 'CI/CD'],
    summary: 'We\'re looking for a strong Backend Engineer who loves building scalable, production-grade systems with Golang. You\'ll take end-to-end ownership of backend services—from architecture to deployment—and work in a fast-paced environment where your code directly impacts product velocity and customer experience. If you thrive on solving hard technical problems, shipping quickly, and building systems that scale, this is your opportunity.',
    applyUrl: 'https://forms.gle/cczcwqa7xpKzLjio9',
    jd: {
      responsibilities: [
      ...
      requirements: [
        ...
        'Strong hands-on expertise with Golang in production environments',
        'Proven experience building APIs and backend services from scratch',
        'Solid understanding of databases: PostgreSQL/MySQL, MongoDB, Redis',
        'Deep knowledge of Go concurrency patterns and performance optimization',
        'Experience with microservices or modular monolith architectures',
        'Thrives in ambiguous, fast-paced startup environments',
        'Strong problem-solving skills and natural sense of ownership',
      ],
      niceToHave: [
